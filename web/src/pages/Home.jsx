            ...
            <div className="flex flex-1 flex-col p-8 lg:p-12 relative overflow-hidden">
                ...
                <nav className="flex items-center justify-between relative z-10">
                    <div className="flex items-center gap-2.5">
                        <div className="size-9 rounded-xl bg-linear-to-br bg-amber-400 to-orange-500 flex items-center justify-center shadow-lg shadow-gray-500/20">
                    ...
                    <div className="flex items-center gap-2">
                        <SignInButton mode="modal">
                            <button className="px-5 py-2.5 text-sm font-medium text-base-content/50 hover:text-base-content transition"> Sign in</button>
                        </SignInButton>
